...
const fortuneData = {
  ...
  advice: {
    ...
    avoid: [
      ...
      "피마루사마의 라이브 방해하기",
      "배틀필드에서 해골 찾기",
      "램파드에게 프리킥으로 거스 맞은 척하기",
      "현자의 돌 찾아 떠나기",
      "연금술 한방으로 집 날리기(인체 연성은 위험합니다!!)",
      "마이 선배의 토끼옷 훔치기",
      "어둠의 실력자 신뢰하기",
      "에드워드처럼 키 재기 거부하기",
      "강찬이를 고양이로 부르기",
      ...
      "세이버보다 길가메시가 강하다 말하기",
      "무한의 검제 세계에서 화장실 참기",
      "진격의 거인 12권 또는 애니메이션 2기 분량 스킵하기",
      "로이 머스탱 앞에서 불장난하기",
    ],
    ...
    do: [
      ...
      "에임 연습 10분씩 꾸준히하기",
      "하루 한 개 새 스모크 스폿 배우기",
      "매일 한 가지 새로운 헤드샷 각도 연습하기",
      "팀원 모두에게 스킨 선물하기",
      "실력 좋은 적에게 친구 신청하기",
      "메르시 궁극기 최대 활용하기",
      "브림스톤 스모크로 팀원 엄폐하기",
      "진 게임에서도 긍정적인 피드백 남기기",
      "매일 다른 요원으로 플레이하기",
      "라인전 끝나면 타워 먼저 밀기",
      "정글러 버프 돕기",
      "맵의 새로운 엄폐물 발견하기",
